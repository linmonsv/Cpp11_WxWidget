...
//(*IdInit(wx1Dialog)
const long wx1Dialog::ID_STATICTEXT1 = wxNewId();
const long wx1Dialog::ID_BUTTON1 = wxNewId();
const long wx1Dialog::ID_STATICLINE1 = wxNewId();
const long wx1Dialog::ID_BUTTON2 = wxNewId();
//*)

BEGIN_EVENT_TABLE(wx1Dialog,wxDialog)
    //(*EventTable(wx1Dialog)
    //*)
END_EVENT_TABLE()

wx1Dialog::wx1Dialog(wxWindow* parent,wxWindowID id)
{
    //(*Initialize(wx1Dialog)
    ...
    Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&wx1Dialog::OnAbout);
    Connect(ID_BUTTON2,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&wx1Dialog::OnQuit);
    //*)
}
...
void wx1Dialog::OnQuit(wxCommandEvent& event)
{
    Close();
}
